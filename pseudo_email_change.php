            ...
            <div class="tab-pane fade active show" id="account-general">
              ...
              <div class="tab-content">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control mb-1" placeholder="Votre nouveau pseudo">
                </div>

                <div class="form-group">
                  <label class="form-label">E-mail</label>
                  <input type="text" class="form-control mb-1" placeholder="Votre nouvelle adresse mail">
                </div>
