...
<?php
    ...
    $query = $pdo->prepare("SELECT id_utilisateur,email,date_de_naissance,abonnements,nb_abonnés,certification,pseudo FROM compte ORDER BY id_utilisateur DESC  LIMIT 10");
    $query->execute();
